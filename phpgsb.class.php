...
class phpGSB
{
    ...
    for next check*/
    public function Backoff($errdata = false, $type)
    {
        if ($type == "data") {
            $file = 'nextcheck.dat';
        } else {
    ...
    start of script)*/
    public function checkTimeout($type)
    {
        if ($type == "data") {
            $file = 'nextcheck.dat';
        } else {
    ...
    public function googleDownloader($url, $options, $followbackoff = false)
    {
        $ch = curl_init();
    ...
    public function processChunks($fulldata, $listname)
    {
        $subarray  = array();
        $addarray  = array();
    ...
    public function saveChunkPart($data, $type, $listname)
    {
    ...
    public function getRanges($listname, $mode)
    {
    ...
    public function getFullRanges($listname)
    {
    ...
    public function formattedRequest($listname)
    {
    ...
    public function deleteRange($range, $mode, $listname)
    {
    ...
    public function hexoct2dec($value)
    {
    ...
    public function flexURLEncode($url, $ignorehash = false)
    {
    ...
    public function makeHostKey($host, $usingip)
    {
        if ($usingip) {
            $hosts = array($host . "/");
        } else {
    ...
    public function makeHashes($prefixarray)
    {
    ...
    public function makePrefixes($host, $path, $query, $usingip)
    {
        $prefixes = array();
    ...
    request*/
    public function processFullLookup($data)
    {
        $clonedata   = $data;
        $extracthash = array();
        while (strlen($clonedata) > 0) {
    ...
    be either).*/
    public function addFullHash($prefix, $chunknum, $fullhash, $listname)
    {
    ...
    public function cacheCheck($prefix)
    {
        foreach ($this->usinglists as $value) {
            $buildtrunk = $value . "-a";
    ...
    public function doFullLookup($prefixes, $originals)
    {
    ...
    public function subCheck($listname, $prefixlist, $mode)
    {
